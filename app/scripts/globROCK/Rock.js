...
var Rock = function ( $glob, $location ) { 
	...
	var constant   	= './rock/RockConstant';
	var core 		= './rock/RockCore';
	var control		= './rock/RockControl';
	var content		= './rock/RockContent';
	var event   	= './rock/RockEvent';
	...
	self.addRock = function(  rock, x, y  ){
			return self.core.glob.addRock( rock, x, y, self.core.rock );
	}
