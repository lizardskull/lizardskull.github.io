...
var RockCore = function ( $name,  $glob, $location ) { 
	...
	healTear:{		value:1, 					writable:true },
	healBruise:{	value:2, 					writable:true },
	healCut:{		value:5, 					writable:true },
	healMortal:{	value:10, 					writable:true },

	//PHYSIC VARIABLES
	physicHeight:{ 	value:100, 					writable:true },
	physicWidth:{ 	value:100, 					writable:true },
	
	static:{		value:false, 			    writable:true },
