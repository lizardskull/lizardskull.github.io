...
var self = require( "globROCK/rock/content/Chariot" )( $core, $control );
...
self.createBox = function( rock ){
  ...
  if ( rock.core.static == true   )    shape = space.addStaticShape( new cp.BoxShape(body, rock.core.physicWidth, rock.core.physicHeight ));
  if ( rock.core.static == false  )    shape = space.addShape(       new cp.BoxShape(body, rock.core.physicWidth, rock.core.physicHeight ));
